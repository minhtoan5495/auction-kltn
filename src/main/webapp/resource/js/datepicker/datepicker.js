...
angular.module('ui.bootstrap.datepicker', [])
    ...
    .directive('datepicker', ['datePickerConfig', function (defaultConfig) {
        "use strict";
        ...
        return {
            ...
            "   <thead>" +
            "       <tr>" +
            "           <th class='left' data-ng-click='changeView(data.currentView, data.leftDate, $event)' data-ng-show='data.leftDate.selectable'><i class='fa fa-long-arrow-left'/></th>" +
            ...
            "           <th class='right' data-ng-click='changeView(data.currentView, data.rightDate, $event)' data-ng-show='data.rightDate.selectable'><i class='fa fa-long-arrow-right'/></th>" +
            "       </tr>" +
            "       <tr>" +
            ...
            link: function (scope, element, attrs) {
                ...
                if (attrs.datepickerConfig) {
                    directiveConfig = scope.$eval(attrs.datepickerConfig);
                }
