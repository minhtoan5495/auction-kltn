				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="content-cart-menu">
							...
							<a href="${pageContext.request.contextPath }/home"><button>Tiếp
									...
									<tfoot>
										<tr class="cart-total-price">
											...
											<td class="cart-right-price" colspan="1"
												style="font-size: 16px;">Tổng tiền tạm tính</td>
								...
								<c:when test="${pageContext.request.userPrincipal==null }">
									<div class="submit-button pull-right"
										...
										<button class="btn btn-danger review_item"
											...
											data-target="#myModal">THANH TOÁN ĐƠN HÀNG</button>
									</div>
