...
<div id="navbar" class="navbar navbar-default          ace-save-state">
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="resource/images/avatar/avatar.png" alt="Jason's Photo" />
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar responsive ace-save-state" style="    background-color: #F2F2F2;
    border-style: solid;
    border-color: #CCC;
    border-width: 0 1px 0 0;">
				...
				<div class="sidebar-toggle sidebar-collapse" id="sidebar-collapse" style="    background-color: #F3F3F3;
    border-color: #E0E0E0;">
...
<script type="text/javascript" src="resource/js/jquery.easypiechart.min.js"></script>
<script type="text/javascript" src="resource/js/jquery.flot.min.js"></script>
<script type="text/javascript" src="resource/js/jquery.flot.pie.min.js"></script>
<script type="text/javascript" src="resource/js/jquery.flot.resize.min.js"></script>
<script type="text/javascript" src="resource/js/jquery.ui.touch-punch.min.js"></script>
<script type="text/javascript" src="resource/js/jquery.sparkline.index.min.js"></script>
</html>