                    ...
                    <ul class="nav nav-pills nav-justified nav-slide-info">
                        <li data-target="#myCarousel" data-slide-to="0"
                            class="active nav-slide-info-item"><a href="#"
                                                                  class="nav-slide-info-item-link">CHÍNH SÁCH ĐỔI TRẢ
                            <small>2
                                ngày sau khi giao nếu không đúng mẫu mã cam kết
                            </small>
                        </a></li>
                        <li data-target="#myCarousel" data-slide-to="1"
                            class="nav-slide-info-item"><a href="#"
                                                           class="nav-slide-info-item-link">MIỄN PHÍ GIAO HÀNG
                            <small>Miễn
                                phí giao hàng với những hóa đơn được cập nhật trên
                            </small>
                        </a></li>
                        <li data-target="#myCarousel" data-slide-to="2"
                            class="nav-slide-info-item"><a href="#"
                                                           class="nav-slide-info-item-link">HÌNH THỨC ĐẤU GIÁ ĐƠN GIẢN
                            <small>Thủ
                                tục đấu giá đơn giản
                            </small>
                        </a></li>
                        <li data-target="#myCarousel" data-slide-to="3"
                            class="nav-slide-info-item"><a href="#"
                                                           class="nav-slide-info-item-link">CHĂM SÓC KHÁCH HÀNG
                            <small>Dịch
                                vụ chăm sóc khách hàng luôn hỗ trợ trong 24h
                            </small>
                        </a></li>
                    </ul>
                                ...
                                <div class="single-product-item">
                                    ...
                                    <div class="single-product-showinfor">
                                        ...
                                        <div class="single-product-info-timecountdown">
                                            ...
                                            <c:choose>
                                                <c:when test="${ product.auctions.get(i).endTime >=now}">
