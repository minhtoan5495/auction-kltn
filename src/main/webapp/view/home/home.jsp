    ...
    <div class="container">
                            ...
                            <div class="carousel-inner">
                                <div class="item">
                                    <div class="col-sm-6">
                                        ...
                                        <a href="#">
                                            <button
                                                    type="button" class="btn btn-default get">Chi tiết
                                            </button>
                                        </a>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <c:forEach var="auction" items="${listProductAuction }">
                                    <div class="item">
                                        <div class="col-sm-6">
                                            <h1>
        ...
        <div class="row">
            <div class="content-page">
                            ...
                            <div class="new-product">
                                <div class="single-product-item">
                                    <div class="single-product-image">
                                        <a href="${pageContext.request.contextPath }/detail?productId=${product.productId}"><img
                                                style="width: 253px; height: 300px;"
                                                src="resource/images/product/${product.images.get(i).imageUrl }"></a>
                                        <div class="overplay-content">
                                            <ul>
                                                <li><a href="${pageContext.request.contextPath }/detail?productId=${product.productId}"><i
                ...
                <div class="row">
                    <h4>${message}</h4>
                    <c:forEach var="product" items="${productAuctions }">
                        <div class="col-sm-3">
                            <div class="new-product">
                                <div class="single-product-item">
                                    <div class="single-product-image">
                                            ...
                                            <div class="item">
                                                <div class="col-sm-3">
                                                    <div class="new-product">
                                                        <div class="single-product-item">
                                                            <div class="single-product-image">
                                                                <a href="${pageContext.request.contextPath }/detail?productId=${productView.productId}"><img
                                                                        style="width: 253px; height: 300px;"
                                                                        src="resource/images/product/${productView.images.get(i).imageUrl }"></a>
                                                                <div class="overplay-content">
                                                                    <ul>
                                                                        <li><a href="${pageContext.request.contextPath }/detail?productId=${productView.productId}"><i
                                                                                class="fa fa-search"></i></a></li>
                                                                        <li><a href="#"><i
