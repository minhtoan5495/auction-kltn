                                ...
                                <div class="item">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="item-slide-product-description">
                                            <p>Công nghệ quai dệt Litekit Ở phiên bản mới của Hunter, Biti's đã thay thế
                                                chất liệu Air Mesh cũ bằng công nghệ mới có tên gọi Liteknit. Đây là
                                                công nghệ dệt để tạo nên phần thân của giày với nhiều lỗ thoáng khí,
                                                tăng sự thoải mái và dễ chịu cho người mang. Ngoài ra, cải tiến này còn
                                                giúp cho việc vệ sinh đôi giày trở nên dễ dàng và thuận tiện hơn.</p>
                                        </div>
                                        <a href="#">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="resource/images/slideImage/bititshunter.png"
                                             class="girl img-responsive" alt="" style="width: 360px;height: 360px"/>
                                    </div>
                                </div>
                                <c:forEach var="auction" items="${listProduct2 }">
                                    <div class="item">
                                        <div class="col-sm-6">
                                            ...
                                            <a href="${pageContext.request.contextPath }/detail?idproduct=${auction.productId}">
                                                <button type="button" class="btn btn-default get">Chi tiết</button>
                                            </a>
                                        </div>
                                        <div class="col-sm-6">
                                ...
                                <div class="single-product-item">
                                    ...
                                    <div class="single-product-showinfor">
                                        ...
                                        <div class="single-product-inforsale">
                                            ...
                                            <a
                                                    href="${pageContext.request.contextPath }/addCart?idproduct=${product.productId}">
                                                <button
                                ...
                                <div class="single-product-item">
                                    ...
                                    <div class="single-product-showinfor">
                                        ...
                                        <div class="single-product-info-timecountdown">
                                            <input value="${product.auctions.get(i).endTime }" id="endTime"
                                                   type="hidden">
                                        ...
                                        <div class="single-product-inforsale">
                                            <a
                                                    href="${pageContext.request.contextPath }/detail?idproduct=${product.productId}">
                                                <button
                                                        class="btn btn-success btn-countdown">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <div class="col-xs-4"><a href="#1"><img
                                                    src="http://placehold.it/300/f44336/000000" class="img-responsive"></a>
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="col-xs-4"><a href="#1"><img
                                                    src="http://placehold.it/300/e91e63/000000" class="img-responsive"></a>
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="col-xs-4"><a href="#1"><img
                                                    src="http://placehold.it/300/9c27b0/000000" class="img-responsive"></a>
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="col-xs-4"><a href="#1"><img
                                                    src="http://placehold.it/300/673ab7/000000" class="img-responsive"></a>
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="col-xs-4"><a href="#1"><img
                                                    src="http://placehold.it/300/4caf50/000000" class="img-responsive"></a>
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="col-xs-4"><a href="#1"><img
                                                    src="http://placehold.it/300/8bc34a/000000" class="img-responsive"></a>
                                            </div>
                                        </div>
                                        <!-- add  more items here -->
                                        <!-- Example item start:  -->
