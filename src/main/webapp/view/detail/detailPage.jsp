...
<section class="main-content-detail">
    <div class="container main-content-detail-contain">
        <div class="row">
                                            ...
                                            <%--<c:otherwise>--%>
                                                ...
                                                <%--<c:if test="${empty liUserAuctions}">--%>
                                                    <%--<div class="row">--%>
                                                        <%--<div class="col-sm-12">--%>
                                                            <%--<div class="detail-win-item">--%>
                                                                <%--<h3 class="detail-win-title">Phiên đấu giá đã kết thúc--%>
                                                                    <%--và không ai đấu giá cho sản phẩm này</h3>--%>
                                                                <%--<img alt=""--%>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <c:if test="${product.transactionType.transactionTypeId==1 }">
