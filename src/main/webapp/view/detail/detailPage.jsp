								...
								<div class="product-detail-price">
									...
									<div class="single-product-inforprice">
										<c:choose>
											...
											<c:otherwise>
												<c:if
													test="${'Auction' ne product.transactionType.transactionTypeName}">
													<h2>
												...
												<c:if
													test="${'Auction' eq product.transactionType.transactionTypeName and product.auctions.get(i).endTime >=now}">
													<label style="color: #0e0e0e">Giá thấp nhất bạn có
														thể đấu:</label>
												<c:if test="${not empty userAuction}">
													<h2>
														<fmt:formatNumber value="${userAuction.price + 10000}"
															type="number" />
													</h2>
													...
													<h2>
														<fmt:formatNumber value="${product.price + 10000}"
															type="number" />
													</h2>
													<input value="${product.price + 10000}"
															type="number" hidden="hidden"
														id="maxPrice">
													<span>VNĐ</span>
													</c:if>
														...
														<c:when test="${pageContext.request.userPrincipal==null }">
															<div class="submit-button">
																<button class="btn btn-danger review_item"
																	...
																	data-target="#myModal">ĐẤU GIÁ</button>
															</div>
																	...
																	<div class="modal-content-order">
																		<div class="modal-header">
																			...
																			<div class="alert alert-success">
																				<strong>Cảnh báo!</strong> Bạn phải đăng nhập mới
							...
							<div class="tab-content-detail" id="detail">
								<div class="tab-pane active">
									...
									<div class="tab-descript">
										<p>${product.description }</p>
										<img src="resource/images/product/${product.imageUrl }"
											style="width: 100%">
									</div>
								</div>
							</div>
				...
				<c:if
					...
					<div class="product-viewed">
						<div class="product-detail-viewed">
							...
							<button type="button" class="btn btn-info btn-lg btn-userAuctions"
								data-toggle="modal" data-target="#userAuction">Có
								${userAuctions.size() } lượt đấu</button>
						</div>
						...
						<div class="modal fade" id="userAuction" role="dialog">
							<div class="modal-dialog">
								...
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
										<h4 class="modal-title">Danh sách tài khoản tham gia đấu</h4>
									</div>
									<div class="modal-body">
										<div class="infor_user_auction">
							<table class="table table-bordered">
