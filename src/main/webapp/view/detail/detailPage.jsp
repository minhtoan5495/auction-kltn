												...
												<div id="countDownAuction">
													...
													<c:choose>
														...
														<c:otherwise>
															<button class="btn btn-danger review_item"
															 data-toggle="modal"
																data-target="#myAuction">ĐẤU GIÁ</button>
															<div class="modal fade" id="myAuction" role="dialog">
																<div class="modal-dialog">
																	...
																	<div class="modal-content-review">
																		<div class="modal-header">
																			<div class="alert alert-success">
																				<strong>Thông báo!</strong> Cảm ơn bạn đã quan tâm
																				đến sản phẩm và có hứng thú khi tham gia đấu giá.Để
																				chắc chắn rằng bạn muốn đấu giá cho sản phẩm này thì
																				xin bạn hãy xác nhận lại một lần nữa..Cảm ơn bạn!!
																			</div>
																		</div>
																		<div class="modal-body">

																			<button type="submit"
																				class="btn btn-danger btn-modal-comment">Xác
																				nhận tại đây</button>
																		</div>
																		<div class="modal-footer">
																			<button type="button" class="btn btn-primary"
