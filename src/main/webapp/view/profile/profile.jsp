                    ...
                    <c:forEach var="invoice" items="${invoices }">
                        <c:if test="${not empty invoice.invoiceDetails}">
                            <tr>
                                ...
                                <td><fmt:formatNumber value="${invoice.invoiceDetails.get(i).product.price}"
                                                      type="number"/> đ
                                </td>
                                <td>${invoice.invoiceStatus.invoiceStatusName }</td>
                                <td class="btn_view_detail_order">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <label class="profile_body_item_name">${orderDetail.product.name}
                                            <p style="color: #59b210; font-weight: 400">Số lượng: ${orderDetail.quantity}</p>
                                            <p style="color: #ff4f4f; font-weight: 400">Giá tiền:
                                                ${orderDetail.price}</p>
                                            <p>Tình trạng sản phẩm</p>
                                            <button class="btn btn-success">Đã mua</button>
                                            <br> <strong><fmt:formatDate value="${order.createDate}"
                                                                         pattern="hh:mm dd-MM-yyyy"/></td></strong>
            ...
            <div class="panel panel-default profile_body_item_order">
                <div class="panel-heading profile_heading_main_item">
                    ...
                    <div class="profile_heading_manager">
                        <a href="${pageContext.request.contextPath }/orderDetail?invoiceId=${invoice.invoiceId}">
                ...
                <c:if test="${not empty invoice.invoiceDetails}">
                    <c:set var="product" value="${invoice.invoiceDetails.get(i).product}"/>
