                                ...
                                <div class="panel-body ">
                                    <table cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <c:forEach var="invoiceDetail" items="${invoice.invoiceDetails }">
                                            <tr class="gradeX">
                                                <td><a
                                                        href="${pageContext.request.contextPath}/detail?productId=${invoiceDetail.product.productId}"><img
                                                        src="${pageContext.request.contextPath}/resource/images/product/${invoiceDetail.product.imageUrl}"
