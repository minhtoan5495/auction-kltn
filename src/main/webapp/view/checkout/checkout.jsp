                                                ...
                                                <table class="tbl-info-order-checkout-detail">
                                                    ...
                                                    <tr>
                                                        <td class="infor_order_title_product">
                                                            <img src="${pageContext.request.contextPath }/resource/images/product/${cart.product.images.get(i).getImageUrl()}"
                                                                 style="width: 100px;height: 100px">
                                                            <p style="margin-left: 5px">${cart.product.name }</p>
                                                        </td>
                                                        <td class="infor_order_title_quantity">${cart.quantity } cái
                                                        </td>
